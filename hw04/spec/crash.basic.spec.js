...
describe('Odin in action > ', function() {
  ...
  describe('Odin.create > ', function() {
    ...
    beforeEach(function() {
      ...
      console.info("My method \"goTo\" before call \"spyOn\"");
      console.log(batMobile.goTo)
      console.error("Call \"spyOn\"")
      spyOn(batMobile, 'goTo');
      console.error("My after \"goTo\" before call \"spyOn\"")
      console.error(batMobile.goTo)
    });
